    ...
    const stockDeProductos = new Promise((resolve,reject)=>{
        setTimeout(()=>{
                resolve([
                    ...
                    {title: 'Dune', stock: 5, autor: "Frank Herbert",description:"Dune es una novela de ciencia ficción escrita por Frank Herbert en 1965. Su éxito fue rotundo; en 1966 ganó el Premio Hugo y en 1965 la primera edición del Premio Nébula a la mejor novela de ciencia ficción.",
                    srcimg:"https://images-na.ssl-images-amazon.com/images/I/81ym3QUd3KL.jpg"},
                   {title: '1984', stock: 10, autor:"George Orwell",description:"1984 de George Orwell es una novela de distopía cuya trama ocurre en Oceanía, un país dominado por un gobierno totalitario que mantiene en constante vigilancia a sus ciudadanos e, incluso, insiste en espiar sus pensamientos para mantener el orden.",
