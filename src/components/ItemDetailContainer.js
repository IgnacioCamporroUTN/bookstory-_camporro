    ...
    <div>
      <ul>
        <li style={{ listStyle: "none" }}>
          <ItemDetail arrayDeProductos={arrayDeProductos}/>
        </li>
      </ul>
    </div>
  );
